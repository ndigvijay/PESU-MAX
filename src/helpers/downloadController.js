...
export async function handleBulkDownload(selectedItems, contentTypes, mergeSlides = false, sender, sendResponse) {
  ...
  try {
    const result = await createBulkDownloadZip(selectedItems, progressCallback, typesToDownload, { mergeSlides });
